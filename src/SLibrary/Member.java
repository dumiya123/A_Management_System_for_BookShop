   ...
   ResultSet rs;
    ...
    public void Connect()
    {
        ...
        try 
        {
            ...
            Logger.getLogger(Member.class.getName()).log(Level.INFO, "Database connection established.");
        } catch (SQLException | ClassNotFoundException ex) {
             Logger.getLogger(Member.class.getName()).log(Level.SEVERE, "Database connection failed.", ex);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Category ID", "Member  Name", "Address", "Phone No"
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
           // pst=conn.prepareStatement("INSERT INTO 'category'('Category_name','Status')values(?,?)");
            ...
            pst = conn.prepareStatement("UPDATE member SET name = ?, phone = ? WHERE `Category ID` = ?");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
           // pst=conn.prepareStatement("INSERT INTO 'category'('Category_name','Status')values(?,?)");
            ...
            pst = conn.prepareStatement("DELETE FROM member WHERE `Category ID` = ?");
            pst.setInt(1, id);
