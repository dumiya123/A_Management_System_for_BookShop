   ...
   ResultSet rs;
    ...
    public void Connect()
    {
        ...
        try 
        {
            ...
            Logger.getLogger(Publisher.class.getName()).log(Level.INFO, "Database connection established.");
        } catch (SQLException | ClassNotFoundException ex) {
             Logger.getLogger(Publisher.class.getName()).log(Level.SEVERE, "Database connection failed.", ex);
...
//                }
////                d.addRow(v2);
                v2.add(rs.getInt(1)); // Column index 1 (Category ID)
                v2.add(rs.getString(2)); // Column index 2 (name)
                v2.add(rs.getString(3)); // Column index 3 (address)
                v2.add(rs.getString(4)); // Column index 4 (phone)
                d.addRow(v2);
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Category ID", "Publisher  Name", "Address", "Phone No"
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
           // pst=conn.prepareStatement("INSERT INTO 'category'('Category_name','Status')values(?,?)");
            ...
            pst = conn.prepareStatement("UPDATE publisher SET name = ?, phone = ? WHERE `Category ID` = ?");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
           // pst=conn.prepareStatement("INSERT INTO 'category'('Category_name','Status')values(?,?)");
            ...
            pst = conn.prepareStatement("DELETE FROM publisher WHERE `Category ID` = ?");
            pst.setInt(1, id);
